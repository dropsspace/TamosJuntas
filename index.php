            ...
            <div class="container">
                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        ...
                        <h4 class="lei-heading">Lei 11.340/06</h4>
                        <p class="text-muted">	jhdgausyas                        
                        </p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-4x">
                    ...
                    <div class="row">
                        <div class="col-lg-8 mx-auto">
                            <div class="modal-body">
                                ...
                                <a href="http://www.acessoajustica.gov.br/pub/sobre/portasDaJustica/consultarPortasDaJustica.faces;jsessionid=0A0GjTuyp81+OlyASFQ7ewDa.undefined" target="_blank"> <button class="btn btn-primary" type="submit">                 
                                        Ver Lei Integral
                                    </button> </a>
